        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{route('customer.store') }}" method="post" enctype="multipart/form-data"  id="" data-parsley-validate class="form-horizontal form-label-left">                           <div class="col-md-12 col-sm-12">
                            @csrf
                            <div class="col-md-3 col-sm-3 ">
                                    ...
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Shop Name</label>
                                        <div class="col-md-10 col-sm-10 ">
                                            <input id="middle-name" class="form-control" type="text" name="Shop_name">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-7 col-sm-7 label-align">Account Holder Name</label>
                                        <div class="col-md-10 col-sm-10 ">
                                            <input id="middle-name" class="form-control" type="text" name="account_holder">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-7 col-sm-7 label-align">Account Number</label>
                                        <div class="col-md-10 col-sm-10 ">
                                            <input id="middle-name" class="form-control" type="text" name="account_number">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-7 col-sm-7 label-align">Bank Name</label>
                                        <div class="col-md-10 col-sm-10 ">
                                            <input id="middle-name" class="form-control" type="text" name="Bank_name">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-7 col-sm-7 label-align">Branch Name</label>
                                        <div class="col-md-10 col-sm-10 ">
                                            <input id="middle-name" class="form-control" type="text" name="Branch_name">
                                        </div>
                                    </div>
